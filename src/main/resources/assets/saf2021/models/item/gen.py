...
mat_names = [('dragonbone', 'dragon'), ('fire_dragonbone', 'fire_dragon'), ('ice_dragonbone', 'ice_dragon'),
             ...
             ('fire_dragonsteel', 'dragonsteel_fire'), ('ice_dragonsteel', 'dragonsteel_ice'), ('lightning_dragonsteel', 'dragonsteel_lightning')]
...
for mat_name, texture_name in mat_names:
    ...
    gen_quarterstaff_model(mat_name, "quarterstaff", MOD_NAME, texture_name)
