...
public class materials {
    ...
    public static WeaponMaterial materialFDB = new WeaponMaterial("fire_dragonbone", SaF2021.modid, 0x0F6363, 0x107272, 4, 8000, 15f, 30f, 69,
            new ResourceLocation("forge:ingots/dragonsteel_lightning"), new FDS("Fiery", SaF2021.modid, WeaponTrait.TraitQuality.POSITIVE));
    public static WeaponMaterial materialIDB = new WeaponMaterial("ice_dragonbone", SaF2021.modid, 0x0F6363, 0x107272, 4, 8000, 15f, 30f, 69,
            new ResourceLocation("forge:ingots/dragonsteel_lightning"), new IDS("Icy", SaF2021.modid, WeaponTrait.TraitQuality.POSITIVE));
    public static WeaponMaterial materialLDB = new WeaponMaterial("lightning_dragonbone", SaF2021.modid, 0x0F6363, 0x107272, 4, 8000, 15f, 30f, 69,
            new ResourceLocation("forge:ingots/dragonsteel_lightning"), new LDS("Shocking", SaF2021.modid, WeaponTrait.TraitQuality.POSITIVE));
    public static WeaponMaterial materialDB = new WeaponMaterial("dragonbone", SaF2021.modid, 0x0F6363, 0x107272, 4, 8000, 15f, 30f, 69,
